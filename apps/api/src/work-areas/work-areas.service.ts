    ...
    return this.db.withTenantClient(companyId, async (client) => {
      ...
      const dataSql = `
        SELECT 
          ...
          wa.level, wa.path, wa.sort_order, wa.is_active, wa.created_at, wa.updated_at,
    ...
    return this.db.withTenantTransaction(companyId, async (client) => {
      ...
      const insertRes = await client.query(
        `INSERT INTO work_areas (
           company_id, project_id, parent_id, name, code, level, path, sort_order, is_active
         ) VALUES ($1, $2, $3, $4, $5, $6, $7, $8, $9)
         RETURNING id, company_id, project_id, parent_id, name, code, level, path, sort_order, is_active, created_at, updated_at`,
        [
          companyId,
          dto.projectId,
          dto.parentId || null,
