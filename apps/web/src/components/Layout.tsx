...
const SIDEBAR_GROUPS: SidebarGroup[] = [
  {
    id: 'overview',
    defaultTitle: 'نظرة عامة والقيادة',
  ...
  {
    id: 'operations',
    defaultTitle: 'عمليات الموقع والتنفيذ',
  ...
  {
    id: 'resources',
    defaultTitle: 'الموارد والبيانات المرجعية',
    icon: <Building size={18} />,
    color: '#34d399',
    links: [
      { to: '/employees', key: 'employees', defaultLabel: 'الكوادر والعمالة', icon: <Users size={18} /> },
      { to: '/branches', key: 'branches', defaultLabel: 'الفروع والقطاعات', icon: <Building size={18} /> },
      { to: '/projects', key: 'projects', defaultLabel: 'المشاريع الميدانية', icon: <FolderKanban size={18} /> },
      { to: '/work-items', key: 'work_items', defaultLabel: 'دليل بنود التشطيبات والمراحل', icon: <CheckSquare size={18} /> },
    ],
  },
  {
    id: 'finance',
    defaultTitle: 'المالية والرقابة والأمان',
  ...
  },
  {
    ...
    color: '#38bdf8',
    links: [
      { to: '/documents', key: 'documents', defaultLabel: 'المستندات والأرشيف السحابي', icon: <FileText size={18} /> },
      { to: '/reports', key: 'reports', defaultLabel: 'التقارير المحفوظة والمؤشرات', icon: <BarChart3 size={18} /> },
      { to: '/alerts', key: 'alerts', defaultLabel: 'قواعد التنبيهات الميدانية', icon: <BellRing size={18} /> },
    ],
  },
  {
    id: 'system',
    defaultTitle: 'إدارة النظام والأمان',
    icon: <Shield size={18} />,
    color: '#f87171',
    links: [
      { to: '/notifications', key: 'notifications', defaultLabel: 'مركز الإشعارات والتنبيهات', icon: <Bell size={18} /> },
      { to: '/users', key: 'users', defaultLabel: 'إدارة الحسابات والمستخدمين', icon: <Users size={18} /> },
      { to: '/rbac', key: 'rbac', defaultLabel: 'مصفوفة الصلاحيات (RBAC)', icon: <Shield size={18} /> },
      { to: '/settings', key: 'settings', defaultLabel: 'إعدادات النظام والنسخ الاحتياطي', icon: <Settings size={18} /> },
    ],
  },
];
